...
const Essential = () => {
  return (
    <div className="relative h-screen bg-[#E2F5FB] flex flex-col justify-start items-center p-4 mb-16">
      ...
      <section className="flex flex-col md:flex-row justify-center items-center gap-16 md:gap-24 mt-8">
        ...
        <div className="flex flex-col gap-9 -mt-24 md:mt-0">
          ...
          <IconCard Icon={MdOutlineEmojiFoodBeverage} title="Functional Foods" description="From protein powders to baby formula" />
            ...
            <div className="hidden lg:flex flex-row gap-2 absolute left-80 top-3/4 transform -translate-x-1/2">
        <div className="w-10 h-10 bg-[#A5B2C3] rounded-full"></div>
        <div className="w-10 h-10 bg-[#A5B2C3] rounded-full"></div>
      </div>
